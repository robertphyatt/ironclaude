      ...
      properties: {
        expected_runtime: {
          ...
          properties: {
            ...
            state_manager_bundle_sha256: { type: 'string' as const },
            workspace_manager_bundle_sha256: { type: 'string' as const },
            workspace_manager_cli_sha256: { type: 'string' as const },
            workspace_manager_hook_intent_sha256: { type: 'string' as const },
