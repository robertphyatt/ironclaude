...
/**
 * Get the episodic memory data directory.
 *
 * LEGACY NAMESPACE: This function and its directory paths use "superpowers"
 * (the plugin's former name). The directory is NOT renamed to "ironclaude"
 * because ~/.config/superpowers/conversation-archive/ contains all indexed
 * conversation data. Renaming would break every existing index and require
 * a full re-index for all users. The legacy name is preserved intentionally.
 *
 * Precedence:
