...
description: Use when user asks 'how should I...' or 'what's the best approach...' after exploring code, OR when you've tried to solve something and are stuck, OR for unfamiliar workflows, OR when user references past work, OR when context feels incomplete after compaction. Searches conversation history.
---
...
- After session compaction/resumption
- When details seem fuzzy or missing
- When you're tempted to guess instead of verify
...
- `mcp__plugin_ironclaude_episodic-memory__show`
