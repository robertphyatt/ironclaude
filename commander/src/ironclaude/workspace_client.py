...
class WorkspaceClient:
    ...
    def reap_orphans(self, payload: dict[str, Any], **transport: Any) -> dict[str, Any]:
        return self._invoke("reap-orphans", payload, **transport)

    def resolve_orphan(self, payload: dict[str, Any], **transport: Any) -> dict[str, Any]:
        return self._invoke("resolve-orphan", payload, **transport)
